...
<div class="aui-message aui-message-change">
    <p class="title">
        <strong>To get the correct result running the request you need to be part of the group "IM-script-administrator"</strong>
        <br>
    </p>
    <p>You can add yourself on this group into Crowd</p>
    <p style="text-align:center"><strong><a href="https://mydoc.com</a></strong></p>
</div>
